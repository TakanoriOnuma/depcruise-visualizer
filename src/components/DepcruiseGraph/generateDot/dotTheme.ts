...
const DOT_CRITERIA_MODULE_THEMES: CriteriaTheme[] = [
  {
...
const DOT_CRITERIA_DEPENDENCY_THEMES: CriteriaTheme[] = [
  {
    criteria: { "rules[0].severity": "error" },
    attributes: { fontcolor: "red", color: "red" },
  },
...
/**
 * DOT言語で使用するグラフのスタイル
 * @see https://github.com/sverweij/dependency-cruiser/blob/v16.4.0/src/report/dot/default-theme.mjs
 */
export const DOT_THEME = {
  ...DOT_BASE_THEME,
  modules: DOT_CRITERIA_MODULE_THEMES,
  dependencies: DOT_CRITERIA_DEPENDENCY_THEMES,
};
